EXPLAIN select cntrycode, count(*) as numcust, 
...
CREATE INDEX idx_customer USING BTREE ON customer (c_phone, c_acctbal, c_custkey);
CREATE INDEX idx_orders USING HASH ON orders (o_custkey);
